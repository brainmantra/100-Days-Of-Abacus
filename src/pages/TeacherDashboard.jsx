              ...
              <div>
                ...
                <div style={{ 
                  ...
                  {Array.from({ length: 100 }, (_, i) => {
                    ...
                    const sectionData = typeof dayRecord?.section_data === 'string' ? JSON.parse(dayRecord.section_data) : (dayRecord?.section_data || {});
                            ...
                            {sections.length > 0 && (
                              <button 
                                ...
                                onClick={async () => {
                                  ...
                                  try {
                                    await teacherApi.delete(`/teachers/students/${selected.id}/progress/${dayNum}/reset`);
                                    toast.success(`Day ${dayNum} reset successfully.`);
                                    const res = await teacherApi.get(`/teachers/students/${selected.id}`);
                                    setSelectedDays(res.data.days || []);
                                  } catch (err) {
                ...
                <div className="stat-grid">
                  ...
                  <StatCard icon="🔥" label="Best Streak" value={selectedStudent.longest_streak || selectedStudent.streak} color="var(--warning)" />
                </div>
